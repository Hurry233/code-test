...
const technicalAdvantages = [
  ...
  },
  {
    icon: Cpu,
    title: "多模型调度引擎",
    description: "灵活选择 GPT-4、Claude、Gemini 等模型，支持按账号或应用级策略路由。",
  },
  {
    icon: Gauge,
    title: "实时监测体系",
...
const antiDowngradeMeasures = [
  ...
  },
  {
    ...
    title: "独立知识库",
    description:
      "构建 XYAI 自研知识库与 Prompt 校验体系，避免关键回答被删改或弱化。",
  },
  {
    icon: Eye,
    title: "人机双重巡检",
...
const faqs = [
  {
    ...
    answer:
      "XYAI 镜像基于官方节点构建，提供等同于官方的功能体验，同时针对国内网络环境进行优化，确保访问稳定且合规。",
  },
  {
            ...
            <div className="grid gap-12 lg:grid-cols-[1.2fr_1fr] lg:items-center">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  XYAI 镜像系统让您无需翻墙即可畅享原生官方能力：支持 GPT-4、DALL·E、代码解释器、插件商店、语音输入等功能，同时提供企业级安全与团队协同支持。
                </p>
            ...
            <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr] lg:items-center">
              <div className="space-y-6">
                ...
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
                  GPT 镜像是在不违背政策的前提下，将海外官方服务的能力、界面与数据完整同步到国内用户。通过 XYAI 的多重网络与安全优化，您可以像使用官网一样，自由调用所有模型与插件能力。
                </p>
              ...
              <div className="relative">
                <Card className="border-primary/20 bg-gradient-to-br from-primary/5 via-background to-background p-8 space-y-5">
                  ...
                  <p className="text-sm text-muted-foreground leading-6">
                    “镜像”不仅仅是访问代理，更是对官方生态的实时复刻。XYAI 镜像通过海外节点直连与本地加速网络，实现账号登录、数据同步、插件调用等全流程体验与官方一致。
                  </p>
        ...
        <section className="py-16 sm:py-24 bg-muted/20">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl text-center mx-auto mb-12 space-y-4">
              <Badge className="w-fit mx-auto bg-primary/10 text-primary">XYAI 镜像的技术优势</Badge>
              ...
              <div className="grid gap-10 lg:grid-cols-[1fr_1.2fr]">
                <div className="p-10 lg:p-14 space-y-6">
                  ...
                  <p className="text-base text-white/70 leading-relaxed">
                    为应对海外平台可能采取的功能限制、质量稀释策略，XYAI 构建了防降智保障体系，确保模型在国内依旧保持一流的推理能力与内容深度。
                  </p>
                </div>
