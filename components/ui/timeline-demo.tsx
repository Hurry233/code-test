  ...
  const data = [
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Expanded our platform with advanced AI capabilities and enterprise features.
            Built robust infrastructure to support millions of users.
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Launched new developer tools and API integrations that power modern applications.
            Here are some highlights from our product evolution.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
      ...
      content: (
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            />
            <Image
              src="https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?w=500&h=500&fit=crop"
